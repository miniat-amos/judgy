...
from competition.views.team_join_accept_view import team_join_accept_view
from competition.views.team_join_decline_view import team_join_decline_view
from competition.views.team_leave_view import team_leave_view
from competition.views.team_invite_view import team_invite_view
from competition.views.team_invite_accept_view import team_invite_accept_view
...
from competition.views.get_teams_view import get_teams_view
from competition.views.get_members_view import get_members_view
...
from competition.views.admin_all_subjproblem_submissions_view import admin_all_subjective_problem_submissions
...
urlpatterns = [
    ...
    path('competition/<str:code>/<str:problem_name>/team/<str:team_name>/user/<str:email>/submission/<str:submission_id>/download', download_submission_view, name='download_submission'),
    ...
    path('competition/<str:code>/all_subjective_problems/submissions', admin_all_subjective_problem_submissions, name="admin_all_subjective_problem_submissions"),
