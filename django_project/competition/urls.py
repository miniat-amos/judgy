...
urlpatterns = [
    ...
    path(
        "competition/<str:code>/<path:problem_name>/team/<path:team_name>/user/<path:email>/submission/<str:submission_id>/<str:submission_number>/download/",
        download_submission_view,
