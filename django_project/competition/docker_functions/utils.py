...
def create_container_volumes(host_filepaths):
    ...
    volumes = {
        ...
        str(to_host_path(host_filepaths["judging_program"])): {"bind": str(container_tmp_judging), "mode": "ro"},
        str(to_host_path(host_filepaths["other_files"])): {"bind": str(container_tmp_others), "mode": "ro"},
        str(to_host_path(host_filepaths["user_submission"])): {"bind": str(container_submission_dir), "mode": "ro"},    
    }
